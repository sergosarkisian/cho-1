...
%define _libversion    %{service_main_version}
...
BuildRequires: libfastlz1-devel
%if 0%{?build_sqlite3}
%if 0%{?suse_version}
...
%__rm -f "%{buildroot}/%{_sysconfdir}/rc.d/init.d"/*
%__rm -f "%{buildroot}/%{_sbindir}/rcbareos"-*
%__rm -f "%{buildroot}/%{_sysconfdir}/init.d"/*
...
#%attr(0640, %{storage_daemon_user}, %{daemon_group}) %config(noreplace) %{_sysconfdir}/bareos-sd.d/device-gluster.conf
%endif
...
#%attr(0640, %{storage_daemon_user}, %{daemon_group}) %config(noreplace) %{_sysconfdir}/bareos-sd.d/device-ceph-rados.conf
%endif
...
%dir %{backend_dir}
%{_sysconfdir}/bareos/bareos-dir.d/plugin-python-ldap.conf
...
%changelog
* Fri Dec 12 2014 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 14.2.2-1
- Switch version number
* Fri Sep 12 2014 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 14.2.1-1
- Switch version number
* Fri Apr 11 2014 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 14.2.0-1
- Switch version number
* Mon Feb  3 2014 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 14.1.0-1
- Switch version number
* Sun Sep 29 2013 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 13.4.0-1
- Switch version number
* Sun Jun 30 2013 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 13.3.0-1
- Switch version number
* Tue Apr  9 2013 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 13.2.0-1
- Switch version number
* Wed Feb 13 2013 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 13.1.0-1
- Switch version number
* Wed Feb  6 2013 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 12.4.1-1
- Switch version number
* Sun Dec 30 2012 Marco van Wieringen <marco.van.wieringen@bareos.com>
- version 12.4.0-7
- enable ndmp and scsi-crypto
- remove deprecated gtk tray monitor
* Wed Dec 12 2012 Joerg Steffens <joerg.steffens@bareos.com>
- version 12.4.0-6
- permissions
- build fixes
* Tue Dec 11 2012 Joerg Steffens <joerg.steffens@bareos.com>
- version 12.4.0-5
- add bareos group and users
- add init scripts
- add logrotate for bareos-dir
* Fri Dec  7 2012 Joerg Steffens <joerg.steffens@bareos.com>
- version 12.4.0-4
- bugfixes: package contents
* Tue Dec  4 2012 Joerg Steffens <joerg.steffens@bareos.com>
- version 12.4.0-3
- cleanup
* Tue Dec  4 2012 Joerg Steffens <joerg.steffens@bareos.com>
- version 12.4.0-2
