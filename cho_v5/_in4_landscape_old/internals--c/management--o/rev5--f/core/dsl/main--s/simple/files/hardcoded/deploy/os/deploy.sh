...
. /media/sysdata/in4/cho/in4_core/deploy/os/build_os-*_env.sh
...
. /media/sysdata/in4/cho/in4_core/deploy/os/1.init/1.pre.sh
if [[ $TYPE == "hw_chroot" ]] ; then . /media/sysdata/in4/cho/in4_core/deploy/os/_sub/hw_chroot/1.init/2.hw_chroot.sh; fi
if [[ $TYPE == "vm_xen" ]] ; then . /media/sysdata/in4/cho/in4_core/deploy/os/_sub/vm_xen/1.init//2.vm_xen.sh; fi
. /media/sysdata/in4/cho/in4_core/deploy/os/1.init/3.exec.sh
if [[ $TYPE == "vm_xen" ]] ; then . /media/sysdata/in4/cho/in4_core/deploy/os/_sub/vm_xen/1.init//4.vm_xen-start.sh; fi
