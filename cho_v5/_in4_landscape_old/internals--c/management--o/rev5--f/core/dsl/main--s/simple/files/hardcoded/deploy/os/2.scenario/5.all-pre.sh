...
### SYNC SERVICE ###
rm -f /etc/systemd/system/in4__sync.service 	&& cp  /media/sysdata/in4/cho/in4_core/deploy/os/3.env/sync_service/in4__sync.service /etc/systemd/system/
rm -f /etc/systemd/system/in4__sync.timer 	&& cp  /media/sysdata/in4/cho/in4_core/deploy/os/3.env/sync_service/in4__sync.timer /etc/systemd/system/
