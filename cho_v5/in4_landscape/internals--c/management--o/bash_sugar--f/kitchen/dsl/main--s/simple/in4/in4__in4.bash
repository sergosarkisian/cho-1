...
alias in4ux='echo "## In4 GIT path - /media/sysdata/in4/cho/ ###"; git -C /media/sysdata/in4/cho/ status; /bin/sh -x /media/sysdata/in4/cho/in4.sh'
alias in4_sync='sudo Task=sync /bin/sh /media/sysdata/in4/cho/in4.sh'
alias in4_diff='git -C /media/sysdata/in4/cho/ diff'
