...
case $DeployOsMode in
  ...
  ;; 
    "hw_chroot"|"hw_bootdrive") export _GRUB2_DISK=$HWBaseDisk; export _GRUB2_DEFAULT_BOOT="ConeCenter - in4 - HW"; in4func_run "internals--c--linux_sys--o--boot--f--grub2--g--main--s" "3_recipe/in4_shell" "grub2_install.recipe.sh"
  ;; 
    esac  
#DOUBLE
