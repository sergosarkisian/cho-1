...
###
.  /media/sysdata/in4/cho/in4_core/internals/deploy/in4_bash/os/vm_xen/run/4.run/vm_tmpl.xl
.  /media/sysdata/in4/cho/in4_core/internals/deploy/in4_bash/os/vm_xen/run/4.run/vm_tmpl.xl > /tmp/$SrvName.xl
.  /media/sysdata/in4/cho/in4_core/internals/deploy/in4_bash/os/vm_xen/run/4.run/in4_xen-deploy_vm.sh
