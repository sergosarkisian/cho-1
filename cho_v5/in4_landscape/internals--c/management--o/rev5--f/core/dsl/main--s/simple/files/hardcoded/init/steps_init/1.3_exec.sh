...
chroot $BUILD_ENV/loop /bin/bash -c "export TYPE=$TYPE; export LO_SYSTEM=$LO_SYSTEM; export IN4_BASEDISK=$IN4_BASEDISK; sh /media/sysdata/in4/cho/cho_v5/in4_landscape/internals--c/management--o/rev5--f/core/dsl/main--s/simple/files/hardcoded/init/$SCENARIO"
###
