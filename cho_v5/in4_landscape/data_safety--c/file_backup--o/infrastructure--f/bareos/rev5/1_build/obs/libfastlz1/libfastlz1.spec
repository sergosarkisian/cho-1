...
Release:        6.1%{?dist}
License:        BSD
Summary:        Zlib-like interface to fast block compression
...
%if 0%{?suse_version}
mv $RPM_BUILD_ROOT/%_docdir/../libfastlz $RPM_BUILD_ROOT/%_docdir
%endif
...
%files
%defattr(-,root,root)
%dir %_docdir/libfastlz
%doc %_docdir/libfastlz/*
%_bindir/*
%_libdir/*.so.*
