    ...
    "deploy") 
        ...
        case $DeployType in
            ...
            "dev" )
                ...
                case $TaskVars in
                    "commit_personal")
                        git pull dev master; git add * && git commit -m "in4_dev"; git push dev master
                    ;;
                    "commit_stable")
                        git pull && git merge  dev/stable -m "in4_stable" && git add * && git commit -m "in4_stable"; git push; git push stable 
                    ;;
                esac
            ;;             
            "context" )
