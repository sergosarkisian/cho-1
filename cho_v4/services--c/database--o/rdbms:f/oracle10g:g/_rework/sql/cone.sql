...
CREATE TABLESPACE E$ALC DATAFILE 
  '/media/storage/database/oracle/wk10/data/main/ealc.dbf' SIZE 5000M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED
LOGGING
ONLINE
PERMANENT
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
...
##DROP TABLESPACE E$ALC INCLUDING CONTENTS AND DATAFILES CASCADE CONSTRAINTS;
...
CREATE USER ALCS
  ...
  ACCOUNT UNLOCK;
  -- 3 Roles for ALCS 
  GRANT CONNECT TO ALCS;
  GRANT EXP_FULL_DATABASE TO ALCS;
  GRANT IMP_FULL_DATABASE TO ALCS;
  ALTER USER ALCS DEFAULT ROLE ALL;
  -- 3 System Privileges for ALCS 
  GRANT GRANT ANY PRIVILEGE TO ALCS;
  GRANT SELECT ANY TABLE TO ALCS;
  GRANT CREATE SESSION TO ALCS;
  -- 1 Object Privilege for ALCS 
    GRANT READ, WRITE ON DIRECTORY SYS.export TO ALCS;
...
CREATE USER E$ALC
  ...
  DEFAULT TABLESPACE E$ALC
  TEMPORARY TABLESPACE TEMP
  PROFILE DEFAULT
  ACCOUNT UNLOCK;
  -- 6 Roles for E$ALC 
  GRANT READ, WRITE ON DIRECTORY import TO E$ALC;
  GRANT READ, WRITE ON DIRECTORY export TO E$ALC;  
  GRANT AQ_USER_ROLE TO E$ALC WITH ADMIN OPTION;
  GRANT CONNECT TO E$ALC;
  GRANT RESOURCE TO E$ALC;
  GRANT CTXAPP TO E$ALC;
  GRANT SESSION_MANAGER TO E$ALC;
  GRANT AQ_ADMINISTRATOR_ROLE TO E$ALC WITH ADMIN OPTION;
  ALTER USER E$ALC DEFAULT ROLE ALL;
  -- 12 System Privileges for E$ALC 
  GRANT CREATE TYPE TO E$ALC;
  GRANT SELECT ANY TABLE TO E$ALC;
  GRANT DEBUG CONNECT SESSION TO E$ALC WITH ADMIN OPTION;
  BEGIN
...
END;
/
  GRANT CREATE ANY VIEW TO E$ALC;
  GRANT CREATE SEQUENCE TO E$ALC;
  GRANT CREATE ANY TABLE TO E$ALC;
  BEGIN
SYS.DBMS_AQADM.GRANT_SYSTEM_PRIVILEGE (
...
END;
/
  GRANT CREATE PROCEDURE TO E$ALC;
  GRANT UNLIMITED TABLESPACE TO E$ALC;
  GRANT CREATE VIEW TO E$ALC;
  GRANT CREATE DATABASE LINK TO E$ALC;
  -- 1 Tablespace Quota for E$ALC 
  ALTER USER E$ALC QUOTA UNLIMITED ON E$ALC;


alter user E$ALC identified by "3edc4rfv";
...
expdp SYSTEM schemas=E\$TOCEAN directory=export FLASHBACK_SCN=33497565554 dumpfile=ealc.dump logfile=ealc.dump.log
...
impdp SYSTEM schemas=E\$ALC directory=export dumpfile=ealc.dump logfile=ealc.import.log table_exists_action=replace
...
impdp E\$ALC schemas=E\$BWS directory=import dumpfile=bws_to_alc.dump logfile=bws_to_alc.import.log remap_schema=E\$BWS:E\$ALC REMAP_TABLESPACE=E\$BWS:E\$ALC

drop table E$ALC.cc_content
...
CREATE DATABASE LINK xml_content_link
 USING 'olddb.WORLD';
    ...
    CREATE TABLE E$ALC.CC_CONTENT of xmltype
    ...
    create index E$ALC.CCREL_REF_idx on E$ALC.CC_RELATION(THEREF, FORMAT);


/* old schema */

CREATE OR REPLACE FORCE VIEW V$CC_CONTENT_EXPORT2
AS
...
create table V$CC_CONTENT_EXPORT2
as
select to_char(data) data
from V$CC_CONTENT_EXPORT2@xml_content_link;
...
begin
  ...
  commit;
    ...
    ALTER TABLE E$ALC.CC_DEPEND ADD (
      CONSTRAINT CCDEPEND_CC_FK
    FOREIGN KEY (CCID)
    REFERENCES E$ALC.CC_CONTENT ("XMLDATA"."CCID")
	ON DELETE CASCADE,
  ...
  -- 51 Object Privileges for E$ALC 
    GRANT EXECUTE ON CTXSYS.CTX_DDL TO E$ALC;
    GRANT EXECUTE ON E$CORE.ADC TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON E$CORE.ADM_CHK_PARAM TO E$ALC WITH GRANT OPTION;
    GRANT DELETE, INSERT, SELECT ON E$CORE.ADM_DEFERRED_CHECK TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.CTX TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.DYNSQL2 TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.ERR TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON E$CORE.KERNEL_LBY TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON E$CORE.KERNEL_MYLBY TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON E$CORE.KERNEL_SVP TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.LBY TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.LCK TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.LCKV TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.P$CC TO E$ALC;
    GRANT DELETE, INSERT, SELECT, UPDATE ON E$CORE.PLSQL_PROFILER_DATA TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON E$CORE.PLSQL_PROFILER_RUNNUMBER TO E$ALC WITH GRANT OPTION;
    GRANT DELETE, INSERT, SELECT, UPDATE ON E$CORE.PLSQL_PROFILER_RUNS TO E$ALC WITH GRANT OPTION;
    GRANT DELETE, INSERT, SELECT, UPDATE ON E$CORE.PLSQL_PROFILER_UNITS TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON E$CORE.S$ADM_ADC TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON E$CORE.S$ADM_SES TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.SEQ TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.STAT_EXEC TO E$ALC;
    GRANT EXECUTE ON E$CORE.TABLE_VARCHAR TO E$ALC;
    GRANT EXECUTE ON E$CORE.UPDATE_CLOB TO E$ALC;
    GRANT EXECUTE ON E$CORE.UTL TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON E$CORE.UTL_JAVA TO E$ALC;
    GRANT EXECUTE ON E$CORE.XMLU TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON SYS.DBMS_AQ TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_AQADM TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_AQ_BQVIEW TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_CRYPTO TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_FLASHBACK TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_LOB TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON SYS.DBMS_LOCK TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_RANDOM TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON SYS.DBMS_RLS TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_RULE_ADM TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_SESSION TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON SYS.DBMS_STREAMS_ADM TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_SYSTEM TO E$ALC;
    GRANT EXECUTE ON SYS.DBMS_UTILITY TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON SYS.GV_$GLOBAL_TRANSACTION TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON SYS.RESET_ALL_PACKAGES TO E$ALC;
    GRANT SELECT ON SYS.TT$LOCK_TBL TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON SYS.TT$PK TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON SYS.TT$PROCEDURES TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON SYS.TT$TAB_IDX_COLS TO E$ALC;
    GRANT SELECT ON SYS.TT$TRANSACTIONS2 TO E$ALC WITH GRANT OPTION;
    GRANT EXECUTE ON SYS.UTL_RAW TO E$ALC WITH GRANT OPTION;
    GRANT SELECT ON SYS.V_$DBLINK TO E$ALC;
    GRANT SELECT ON SYS.V_$GLOBALCONTEXT TO E$ALC;
  ...
  -- 98 Object Privileges for EDI_WEB 
    ...
    GRANT EXECUTE ON E$ALC.A$AIS TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$CMPRLS TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$CORE TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$CP TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$DOC TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$EPN TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$ERR TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$GIS TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$HISTORY TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$LOG TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$NOTICE TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$PRINT TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$REG TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$SCHED TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$SSN TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$VCALL TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.A$XTEE TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.FULLNAME TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$ADM TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$BCH2 TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$CC TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$CR TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$CRI TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$DEMON TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$DICT TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$DNUM TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$DYN2 TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$ERR TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$LNG TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$MENU TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$MT TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.I$UREG TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.KERNEL TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.LNG TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.RLS TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.SCONST TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.TABLE_TOBJATTR TO EDI_WEB;
    GRANT EXECUTE ON E$ALC.TOBJATTR TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_BYLIST TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_CHK_PARAM TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DEFERRED_CHECK TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICTRLS_LSS TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_CH TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_FLT TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_FLT_LIST TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_FLT_SIMPLE TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_LIST TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_LSS TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_NAME TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_NAME_FLT TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_NAME_LNG TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_DICT_TYPE TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_LOCK_TBL TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$ADM_WS TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CMS_HOST TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CMS_MIMETYPES TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CMS_SITE TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CMS_SITE_HOSTS TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CMS_SITE_LNG TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CRI_CHOBJINH_VAL TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CRI_OBJINH TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CRI_OBJINHCC TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CR_MCA TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CR_OBJ TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CR_OBJATID TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CR_OBJREL TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CR_OBJTREL TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CR_OBJTYPE TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$CR_OBJ_WS TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$DOC_INDEX TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$DOC_INH_PARAMS TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$DOC_OBJ_CH TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$LNG_LANGUAGE TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$LNG_TRANSLATE TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$MENU_FAV TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$MENU_GO TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$MT_USER TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$MT_USER_DT TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$MT_USER_HIST TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$MT_USER_SU TO EDI_WEB;
    GRANT SELECT ON E$ALC.V$MT_USER_WS TO EDI_WEB;
    ...
    grant EXECUTE on E$ALC.SYSTPuoC2p/N6FovgQMRYzaJkbw== to PUBLIC;
    grant EXECUTE on E$ALC.SYSTPux8+o9CP317gQMRYzaITiA== to PUBLIC;
    grant EXECUTE on E$ALC.SYSTPuoC2p/N/FovgQMRYzaJkbw== to PUBLIC;
...
begin dbms_stats.gather_schema_stats ( ownname          => 'E$ALC' ); end;
